...
class Form extends Component{
    ...
    render(){
        ...
        return(
           ...
           <Link to="/"> <img src="https://www.careercarve.com/careercarve-logo-white.png" alt="logo"  className='hme-logo'/>
           </Link> <div className='cont-2'>
               
                  {isSubmitted?( 
                    <div className='success-cont'>
                        <FontAwesomeIcon icon={faCheckCircle} size="3x" color="#44f50f" />
